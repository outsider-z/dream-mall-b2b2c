<template>
  <div class="app-container">
    ...
    <el-table v-if="refreshTable" v-loading="loading" :data="menuList" row-key="id" :default-expand-all="isExpandAll"
      ...
      <el-table-column prop="cateName" label="类目名称" :show-overflow-tooltip="true" width="300"></el-table-column>
      <el-table-column prop="catePicUrl" label="类目封面" width="300" align="center">
        <template slot-scope="scope">
          <el-popover placement="right" width="200" trigger="hover">
            <img :src="scope.row.catePicUrl" alt="" style="width: 150px;height: 150px">
            <img slot="reference" :src="scope.row.catePicUrl" style="max-height: 50px;max-width: 50px">
          </el-popover>
        </template>
      </el-table-column>
      <el-table-column prop="sort" label="排序" sortable width="300" align="center"></el-table-column>
      <el-table-column prop="displayedHomeFlag" label="首页显示" width="200" align="center">
        <template slot-scope="scope">
          ...
          <el-col :span="24">
            <el-form-item label="类目封面" prop="catePicUrl">
              <el-upload class="avatar-uploader" :action="uploadFileUrl" :show-file-list="false" :headers="headers"
                ...
                <img v-if="form.catePicUrl" :src="form.catePicUrl" class="avatar">
