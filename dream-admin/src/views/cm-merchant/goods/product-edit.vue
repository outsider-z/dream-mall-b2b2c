            ...
            <el-col :span="12">
              <el-form-item label="商家名称" label-width="130px" prop="merchantName">
                <el-select v-model="formData.merchantName" filterable remote reserve-keyword placeholder="请输入关键词"
                  :remote-method="remoteMethod" :loading="loading" disabled @change="selectChange"
                  :style="{width: '100%'}">
          ...
          <div v-if="formData.productType == '2' || formData.productType == '3'">
            ...
            <el-col :span="24" v-if="formData.validType == '2'">
              <el-form-item label="有效天数" label-width="130px" prop="validDays">
                <el-input v-model="formData.validDays" placeholder="请输入有效天数(仅用于电子卡券商品)" clearable
                  :style="{width: '50%'}">
            ...
            <el-form-item label="商品详情图" label-width="130px" prop="productDetailImgList">
              <el-upload :action="uploadFileUrl" list-type="picture-card" :headers="headers" :file-list="detailList"
                ...
                :on-success="handleDetailSuccess" :on-remove="handleRemove">
                  <img v-if="formData.productDetailImgList" v-for="(item,index) in productDetailImgList" :src="`${imgHost}` + item.imgUrl" alt="" class="el-upload-list__item-thumbnail ">
                <i class="el-icon-plus"></i>
