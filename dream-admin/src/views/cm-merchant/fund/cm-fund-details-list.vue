  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true">
      <el-form-item prop="" label="申请时间">
        <el-date-picker v-model="dateRange" type="daterange" @change="timeChange" range-separator="至" value-format="yyyy-MM-dd"
          start-placeholder="开始日期" end-placeholder="结束日期">
        </el-date-picker>
      </el-form-item>
      <el-form-item prop="transactionType" label="交易类型">
        <el-select v-model="queryParams.transactionType" placeholder="请选择提现状态" clearable :style="{ width: '100%' }">
    ...
    <el-table v-loading="loading" :data="fundDetailsList"  :border="true" table-layout="auto">
      <el-table-column label="日期" align="center" prop="withdrawTime" >
