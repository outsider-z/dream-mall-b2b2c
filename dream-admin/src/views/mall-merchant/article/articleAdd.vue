    ...
    <el-tabs v-model="activeName" @tab-click="handleClick">
      <el-tab-pane label="商品信息" name="first">
        <el-form ref="elForm" :model="formData" :rules="rules" size="medium" label-width="100px">
          ...
          <el-row :gutter="15">
            <el-col :span="12">
              <el-form-item label="商品描述" label-width="130px" prop="productBrief">
                <el-input v-model="formData.productBrief" placeholder="请输入商品描述" :maxlength="30" clearable
          ...
          <el-col :span="24">
            <el-form-item label="商品Banner图片" label-width="130px" prop="productRotagramList">
              <el-upload :action="uploadFileUrl" :headers="headers" list-type="picture-card" :before-upload="beforeAvatarUpload"
                :on-preview="handleBannerCardPreview" :on-success="handleBnnerSuccess" :on-remove="handleRemoveBanner">
          ...
          <el-col :span="24">
            <el-form-item label="商品详情图" label-width="130px" prop="productDetailImgList">
              <el-upload :action="uploadFileUrl" list-type="picture-card" :headers="headers" :before-upload="beforeAvatarUpload"
                :on-preview="handlePictureCardPreview" :on-success="handleDetailSuccess" :on-remove="handleRemove">
                <i class="el-icon-plus"></i>
      ...
      <el-tab-pane label="规格库存" name="third">
        <el-form :model="formData" class="demo-form-inline" :rules="rules">
          ...
          <el-row :gutter="20" v-for="(item,index) in formData.productSkuAttrRequestList" :key="index" v-if="formData.skuFlag=='0'">
            <el-col :span="6">
