<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="shopperList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="订单编号" prop="transactionCode" width="200" align="center" />
      <el-table-column label="日期" align="center" prop="transactionTime" width="160">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.transactionTime) }}</span>
        </template>
      </el-table-column>
      <el-table-column label="奖金类型" prop="transactionType" width="200" align="center" />
      <el-table-column label="奖金金额" prop="transactionAmount" width="200" align="center" />
      <el-table-column label="会员名称" prop="name" width="200" align="center">
        <template slot-scope="scope">
          <span>{{scope.row.name}}</span>
        </template>
      </el-table-column>
      <el-table-column label="手机号码" prop="personalPhone" width="200" align="center">
        <template slot-scope="scope">
            <span>{{scope.row.personalPhone}}</span>
          </template>
        </el-table-column>
      <el-table-column label="明细" prop="transactionDesc" width="200" align="center" />
