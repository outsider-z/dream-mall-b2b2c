  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" >
      <el-form-item label="申请人" prop="userName">
        <el-input v-model="queryParams.userName" placeholder="请输入申请人名称" clearable  />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="cardList" border>
      ...
      <el-table-column label="状态"  width="200" align="center" >
        <template slot-scope="scope">
          <dict-tag :style="scope.row.withdrawStatus=='APPROVED'?'color:#67C23A':'color:#E6A23C'" :options="dict.type.sys_review_type" :value="scope.row.withdrawStatus" />       
         </template>
      </el-table-column>
      ...
      timeChange(val) {
        ...
        handleExport() {
          if(this.queryParams.startTime=='' ||this.queryParams.stopTime=='' ){
            this.$modal.msgSuccess("请输入导出时间条件");
            return
          }
          this.download('merchant/admin/withdrawal/export', {
            ...this.queryParams
