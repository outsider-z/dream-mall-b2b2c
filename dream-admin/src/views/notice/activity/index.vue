<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd"
          v-hasPermi="['system:brand:add']">发布活动</el-button>
      </el-col>
      <el-col :span="1.5">
    ...
    <el-table v-loading="loading" :data="modularList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="活动标题" prop="articleTitle" width="300" align="center" />
      <el-table-column prop="img" label="活动封面" width="300" align="center">
        <template slot-scope="scope">
          <el-popover placement="right" width="180" trigger="hover">
            <img :src="scope.row.coverImageUrl" alt="" style="width: 150px;height: 150px">
            <img slot="reference" :src="scope.row.coverImageUrl" style="max-height: 80px;max-width: 80px">
          </el-popover>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open">
      <el-form ref="elForm" :model="formData" :rules="rules" size="medium" label-width="100px">
        <el-form-item label="活动标题" prop="articleTitle">
          <el-input v-model="formData.articleTitle" placeholder="请输入活动标题" clearable :style="{width: '100%'}">
          </el-input>
        </el-form-item>
        <el-form-item label="封面图片" prop="coverImageUrl">
          <el-upload class="avatar-uploader" :action="uploadFileUrl" :show-file-list="false" :headers="headers"
            ...
            <img v-if="formData.coverImageUrl" :src="formData.coverImageUrl" class="avatar">
  ...
  export default {
    ...
    methods: {
      ...
      handleAvatarSuccess(res, file) {
        this.formData.coverImageUrl = res.data.url;
        if (this.formData.coverImageUrl != '') {
          this.$refs.elForm.clearValidate('coverImageUrl') //清除图片校验文字
        }
      },
